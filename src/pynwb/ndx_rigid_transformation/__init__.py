...
__spec_path = __location_of_this_file / "spec" / "ndx-rigid-transformation.namespace.yaml"

# If that path does not exist, we are likely running in editable mode. Use the local path instead
if not __spec_path.exists():
    __spec_path = __location_of_this_file.parent.parent.parent / "spec" / "ndx-rigid-transformation.namespace.yaml"
